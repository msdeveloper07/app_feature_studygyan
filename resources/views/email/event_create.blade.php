                                ...
                                <table width="80%"  style="width: 80%;max-width: 540px;margin: 0 auto;" cellpadding="0" cellspacing="0">
                                    ...
                                    <tr>
                                        <td style="color: #313131;text-align: center;font-family: 'Open Sans', sans-serif;background: rgb(249 77 74 / 10%);padding: 10px 10px 0px;border-radius: 10px;">
                                            <h1 style="margin: 0;margin-bottom:10px;font-size: 20px;line-height: 30px;font-family: 'Open Sans', sans-serif;font-weight: 600;">  <span ><img src="{{url('/')}}/img/l.png" alt=""></span> <span style="color: #f94d4a;font-weight: 700;">{{$category}}</span> <span ><img src="{{url('/')}}/img/r.png" alt=""></span></h1>
                                        </td>
                                    </tr>
                                </table>
                            </td>
                                ...
                                <table width="80%"  style="width: 80%;max-width: 540px;margin: 0 auto;" cellpadding="0" cellspacing="0">
                                    <tr>
                                        <td style="color: #303030;font-family: 'Open Sans', sans-serif;">
                                            <p style="margin: 0;font-size: 16px;margin-bottom:10px;line-height: 35px;font-family: 'Open Sans', sans-serif;font-weight: bold;"><span style="font-weight: 400;"> Hello</span> {{$username}}, </p>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td style="color: #303030;font-family: 'Open Sans', sans-serif;">
                                            <h2 style="margin: 0;margin-bottom:10px;font-size: 16px;line-height: 24px;font-family: 'Open Sans', sans-serif;">Your reminder has been successfully created for <span style="color: #f94d4a;font-weight: 700;">Mum's Birthday</span> held on <span style="color: #f94d4a;font-weight: 700;">{{$event_date}}.</span></h2>
                                            <p style="text-align: center;">
                                                <img src="{{url('/')}}/img/placeholder.png" alt="">
                                            </p>
